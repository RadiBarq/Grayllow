    ...
    private void attemptLogin() {
        ...
        if (cancel) {
            ...
            public void processFinish(String s) {
                ...
                {
                    Toast.makeText(Register.this, "Thank you for your registration", Toast.LENGTH_SHORT).show();
                    finish();
                    Intent intent = new Intent(Register.this, LoginActicity.class);
                ...
                {
                    Toast.makeText(Register.this, "Something wrong happened try again", Toast.LENGTH_LONG).show();
                    showProgress(false);
                }
